...
public class GetOrderByIdTest {
		...
		@Test
		public void test01GetOrderById()
		{
				var orderId = order.createOrderAndGetId(idPlace,userId,token,dotenv);
				System.out.println("OrderID is: " + orderId); // просто получение айди заказа
		}
